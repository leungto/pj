...
def get_available_time_slots(
    ...
    reservations= db.query(models.Reservation).filter(models.Reservation.seat_id == seatId, models.Reservation.date == date).all()
    ...
    return structure_time_slot_data(available_time_slots)  # 返回所有时间段
